var Actions = {
    ...
    doAction: function (spread, action) {
    ...
    setTextBold: function (spread, options) {
        ...
        Actions.doAction(spread, action);
    },
...
function DesignerActionBase(spread) {
    GcSpread.Sheets.UndoRedo.ActionBase.call(this);
    this._spread = spread;
    this._original = {};
...
setBaseClass(DesignerActionBase, GcSpread.Sheets.UndoRedo.ActionBase);
...
SetFormulaSparklineAction.prototype.execute = function (arg) {
    var self = this, sheet = self._sheet, spread = self._spread, row = self._row, col = self._col, formulaStr = self._formula;
...
SetCommentLockTextAction.prototype.execute = function (arg) {
    var comment = this._comment, value = this._value, property = this._property;
    var lockText = comment.lockText();
    this.updateCommentProperty(comment, property, lockText, value)
};
...
SetCommentDynamicSizeAction.prototype.execute = function (arg) {
    var comment = this._comment, value = this._value, property = this._property;
    var dynamicSize = comment.dynamicSize();
    this.updateCommentProperty(comment, property, dynamicSize, value)
};
...
SetCommentDynamicMoveAction.prototype.execute = function (arg) {
    var comment = this._comment, value = this._value, property = this._property;
    var dynamicMove = comment.dynamicMove();
    this.updateCommentProperty(comment, property, dynamicMove, value)
};
...
SetCommentShowShadowAction.prototype.execute = function (arg) {
    var comment = this._comment, value = this._value, property = this._property;
    var showShadow = comment.showShadow();
    this.updateCommentProperty(comment, property, showShadow, value)
};
...
SetCommentPaddingAction.prototype.undo = function () {
    ...
    if (comment) {
        ...
        if (value) {
            comment.padding(new GcSpread.Sheets.Padding(parseInt(value.left, 10), parseInt(value.top, 10), parseInt(value.right, 10), parseInt(value.bottom, 10)));
        } else {
...
SetCommentPaddingAction.prototype.execute = function (arg) {
    var self = this, spread = self._sheet, comment = self._comment, value = self._value;
    ...
    if (comment && value) {
        ...
        if (para.length === 1) {
            comment.padding(new GcSpread.Sheets.Padding(parseInt(para[0], 10)));
        } else if (para.length === 4) {
            comment.padding(new GcSpread.Sheets.Padding(parseInt(para[0], 10), parseInt(para[1], 10), parseInt(para[2], 10), parseInt(para[3], 10)));
        }
    }
    spread.isPaintSuspended(false);
};
...
SetCommentDisplayModeAction.prototype.execute = function (arg) {
    var comment = this._comment, value = this._value, property = this._property;
    var displayMode = comment.displayMode();
    this.updateCommentProperty(comment, property, displayMode, value)
};
...
SetCommentOpacityAction.prototype.execute = function (arg) {
    var comment = this._comment, value = this._value, property = this._property;
    var opacity = comment.opacity();
    this.updateCommentProperty(comment, property, opacity, value)
};
...
SetCommentForeColorAction.prototype.execute = function (arg) {
    var comment = this._comment, value = this._value, property = this._property;
    var foreColor = comment.foreColor();
    this.updateCommentProperty(comment, property, foreColor, value)
};
...
SetCommentBackColorAction.prototype.execute = function (arg) {
    var comment = this._comment, value = this._value, property = this._property;
    var backColor = comment.backColor();
    this.updateCommentProperty(comment, property, backColor, value)
};
...
SetCommentHorizontalAlignAction.prototype.execute = function (arg) {
    var comment = this._comment, value = this._value, property = this._property;
    var horizontalAlign = comment.horizontalAlign();
    this.updateCommentProperty(comment, property, horizontalAlign, value)
};
...
SetCommentBorderColorAction.prototype.execute = function (arg) {
    var comment = this._comment, value = this._value, property = this._property;
    var borderColor = comment.borderColor();
    this.updateCommentProperty(comment, property, borderColor, value)
};
...
SetCommentBorderStyleAction.prototype.execute = function (arg) {
    var comment = this._comment, value = this._value, property = this._property;
    var borderStyle = comment.borderStyle();
    this.updateCommentProperty(comment, property, borderStyle, value)
};
...
SetCommentBorderWidthAction.prototype.execute = function (arg) {
    var comment = this._comment, value = this._value, property = this._property;
    var borderWidth = comment.borderWidth();
    this.updateCommentProperty(comment, property, borderWidth, value)
};
...
SetCommentTextDecorationAction.prototype.execute = function (arg) {
    var comment = this._comment, value = this._value, property = this._property;
    var textDecoration = comment.textDecoration();
    this.updateCommentProperty(comment, property, textDecoration, textDecoration ^ value)
};
...
SetCommentFontWeightAction.prototype.execute = function (arg) {
    var comment = this._comment, value = this._value, property = this._property;
    var fontWeight = comment.fontWeight();
    this.updateCommentProperty(comment, property, fontWeight, value)
};
...
SetCommentFontStyleAction.prototype.execute = function (arg) {
    var comment = this._comment, value = this._value, property = this._property;
    var fontStyle = comment.fontStyle();
    this.updateCommentProperty(comment, property, fontStyle, value)
};
...
SetCommentFontFamilyAction.prototype.execute = function (arg) {
    var comment = this._comment, value = this._value, property = this._property;
    var fontFamily = comment.fontFamily();
    this.updateCommentProperty(comment, property, fontFamily, value)
};
...
SetCommentFontSizeAction.prototype.execute = function (arg) {
    var comment = this._comment, value = this._value, property = this._property;
    var fontSize = comment.fontSize();
    this.updateCommentProperty(comment, property, fontSize, value)
};
...
InsertCommentAction.prototype.execute = function (arg) {
    var self = this, sheet = self._sheet, spread = self._spread;
    var selection = self._selections[self._selections.length - 1];
    var row = selection.row, col = selection.col;
    var comment, needEdit;
    if (!this._inited) {
        needEdit = true;
        this._inited = true;
        this._oldComment = comment = new GcSpread.Sheets.Comment();
    } else {
        comment = this._oldComment;
    }
    spread.isPaintSuspended(true);
    sheet.setComment(row, col, comment);
    spread.isPaintSuspended(false);
    if (needEdit) {
        comment.commentState(GcSpread.Sheets.CommentState.Edit);
    }
};
...
SetTextBoldAction.prototype.execute = function (arg) {
    var value = !!this._value ? "bold" : "normal", property = this._property, attribute = "font-weight";
    this.setStyle(attribute, property, value);
};
...
SetTextItalicAction.prototype.execute = function (arg) {
    var value = !!this._value ? "italic" : "normal", property = this._property, attribute = "font-style";
    this.setStyle(attribute, property, value);
};
...
SetTextUnderlineAction.prototype.execute = function (arg) {
    var value = !!this._value, property = this._property, attribute = property;
    var flag = GcSpread.Sheets.TextDecorationType.Underline;
    this.setStyle(attribute, property, value, this.getTextDecoration, [flag]);
};
...
SetTextStrikethroughAction.prototype.execute = function (arg) {
    var value = !!this._value, property = this._property, attribute = property;
    var flag = GcSpread.Sheets.TextDecorationType.LineThrough;
    this.setStyle(attribute, property, value, this.getTextDecoration, [flag]);
};
...
SetTextOverlineAction.prototype.execute = function (arg) {
    var value = !!this._value, property = this._property, attribute = property;
    var flag = GcSpread.Sheets.TextDecorationType.Overline;
    this.setStyle(attribute, property, value, this.getTextDecoration, [flag]);
};
...
SetTextFontFamilyAction.prototype.execute = function (arg) {
    var value = this._value, property = this._property, attribute = "font-family";
    this.setStyle(attribute, property, value);
};
...
SetTextFontSizeAction.prototype.execute = function (arg) {
    var value = this._value, property = this._property, attribute = "font-size";
    this.setStyle(attribute, property, value);
};
...
SetTextBackColorAction.prototype.execute = function (arg) {
    var value = this._value, property = this._property, attribute = "backColor";
    this.setStyle(attribute, property, value);
};
...
SetTextForeColorAction.prototype.execute = function (arg) {
    var value = this._value, property = this._property, attribute = "foreColor";
    this.setStyle(attribute, property, value);
};
...
SetBorderAction.prototype.execute = function (arg) {
...
SetBorderAction.prototype.setBorderStyle = function (range, index) {
    var sheet = this._sheet, value = index, outline = value.all || value.outline, rowCount = sheet.getRowCount(), columnCount = sheet.getColumnCount(), startRow = range.row, endRow = startRow + range.rowCount - 1, startCol = range.col, endCol = startCol + range.colCount - 1;
...
SetTextAlignsAction.prototype.execute = function (arg) {
    var value, self = this, property = self._property, attribute = property;
...
SetCellTypeAction.prototype.execute = function (arg) {
    var value = this._value, property = this._property, attribute = property;
    this.setStyle(attribute, property, value);
};
...
SetWrapTextAction.prototype.execute = function (arg) {
    var value = this._value, property = this._property, attribute = property;
    this.setStyle(attribute, property, value);
};
...
SetMergeCenterAction.prototype.execute = function (arg) {
    var self = this, sheet = self._sheet, spread = self._spread, selectionRanges = self._selectionRanges;
    var isMerge = self._value;
    ...
    selectionRanges.forEach(function(range) {
        ...
        for (var i = 0, r; i < rowCount; i++) {
            ...
            for (var j = 0, c; j < colCount; j++) {
                c = col + j;
                if (!spans.some(function(range) { return range.contains(r, c); })) {
...
IndentAction.prototype.execute = function (arg) {
    var value = this._value, property = this._property, attribute = property;
    this.setStyle(attribute, property, value, getTextIndent)
...
SetCellFormatAction.prototype.execute = function (arg) {
    var value = this._value, property = this._property, attribute = property;
    this.setStyle(attribute, property, value);
};
...
IncreaseDecimalAction.prototype.execute = function (arg) {
    var self = this, sheet = self._sheet, spread = self._spread, property = self._property, attribute = property, selection = self._selections[self._selections.length - 1];
    var original = self._original = {styles: {}};
    spread.isPaintSuspended(true);
    self.execInSelections(sheet, attribute, function (sheet, row, column) {
        var style = sheet.getStyle(row, column);
...
DecreaseDecimalAction.prototype.execute = function (arg) {
    var self = this, sheet = self._sheet, spread = self._spread, property = self._property, attribute = property, selection = self._selections[self._selections.length - 1];
    var original = self._original = {styles: {}};
    spread.isPaintSuspended(true);
    self.execInSelections(sheet, attribute, function (sheet, row, column) {
...
SetCellLockAction.prototype.execute = function (arg) {
    var value = this._value, property = this._property, attribute = property;
    this.setStyle(attribute, property, value);
};
...
SetIsProtectAction.prototype.execute = function (arg) {
    this._sheet.setIsProtected(this._value);
};
SetIsProtectAction.prototype.canUndo = function (arg) {
    return false;
};
...
ClearAllAction.prototype.execute = function (arg) {
    var property = this._property, flag = 64 | 32 | 16 | 8 | 4 | 2 | 1;
    this.clear(property, flag);
};
...
ClearFormattingAction.prototype.execute = function (arg) {
    var property = this._property, flag = 2;
    this.clear(property, flag);
};
...
ClearDataAction.prototype.execute = function (arg) {
    var property = this._property, flag = 1;
    this.clear(property, flag = 1);
};
...
AddTableAction.prototype.execute = function (arg) {
    var self = this, sheet = self._sheet, spread = self._spread, property = self._property;
...
AddPictureAction.prototype.execute = function (arg) {
    var self = this, sheet = self._sheet, spread = self._spread, pictureUrl = self._pictureUrl;
    var selection = self._selections[0];
...
InsertRowsAction.prototype.execute = function (arg) {
    var self = this;
...
InsertColumnsAction.prototype.execute = function (arg) {
    var self = this;
...
InsertRightCellsAction.prototype.execute = function (arg) {
    if (getSelectionType(this._selections) === SelectionRangeType.OnlyCells) {
        var sortedRanges = this.getSortedSelections(false),
        ...
        for (i = 0; i < length; i++) {
            r = sortedRanges[i];
            this._sheet.addColumns(colCount, r.colCount);
            this._sheet.moveTo(r.row, r.col, r.row, r.col + r.colCount, r.rowCount, colCount - r.col, option);
        }
    }
};
...
InsertDownCellsAction.prototype.execute = function (arg) {
    if (getSelectionType(this._selections) === SelectionRangeType.OnlyCells) {
        var sortedRanges = this.getSortedSelections(true),
        ...
        for (i = 0; i < length; i++) {
            r = sortedRanges[i];
            this._sheet.addRows(rowCount, r.rowCount);
            this._sheet.moveTo(r.row, r.col, r.row + r.rowCount, r.col, rowCount - r.row, r.colCount, option);
        }
    }
};
...
DeleteRowsAction.prototype.execute = function (arg) {
    var self = this;
    self.processWithRowColumns(true, function (row, rowCount) {
...
DeleteColumnsAction.prototype.execute = function (arg) {
    var self = this;
    self.processWithRowColumns(false, function (col, colCount) {
...
DeleteLeftCellsAction.prototype.execute = function (arg) {
    var sortedRanges = this.getSortedSelections(false);
    for (var i = 0; i < sortedRanges.length; i++) {
        ...
        this._sheet.moveTo(r.row, r.col + r.colCount, r.row, r.col, r.rowCount, this._sheet.getColumnCount() - (r.col + r.colCount), option);
    }
};
...
DeleteUpCellsAction.prototype.execute = function (arg) {
    var sortedRanges = this.getSortedSelections(true);
    for (var i = 0; i < sortedRanges.length; i++) {
        var r = sortedRanges[i];
        // TODO: Why w/o comment (4)
        var option = 256 /* BindingPath */ | 2 /* Formula */ | 8 /* RangeGroup */ | 32 /* Span */ | 16 /* Sparkline */ | 64 /* Style */ | 128 /* Tag */ | 1 /* Value */;
        this._sheet.moveTo(r.row + r.rowCount, r.col, r.row, r.col, this._sheet.getRowCount() - (r.row + r.rowCount), r.colCount, option);
    }
};
...
var util = {};
(function (util) {
    var SheetArea = GcSpread.Sheets.SheetArea;
